        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (islem == "1")//Kullanıcı Ekle
                {
                    ...
                    Console.WriteLine("Yabancı Dil(Yok ise'-' Birden fazla ise araya'/'): ");
                    yabancidil = Console.ReadLine();
                    Console.WriteLine("Ehliyet(Yok ise'-'): ");
                ...
                else if (islem == "5")//Filtreleme işlemleri
                {
                    ...
                    {
                        kisiBilAgac.filterList.Clear();
                        kisiBilAgac.lisansFiltreOkut();
                    }
                    else if (islem == "3")
                    {
                        kisiBilAgac.filterList.Clear();
                        kisiBilAgac.birdenFazlaDilOkut();
                    }
                    else if (islem == "4")
                    {
                        kisiBilAgac.filterList.Clear();
                        kisiBilAgac.deneyimsizlerFiltreOkut();
                    }
                    else if (islem == "5")
                    {
                    ...
                    else if (islem == "8")
                    {
                        ...
                        kisiBilAgac.ismeGoreFiltreOkut(ad);
                    }
